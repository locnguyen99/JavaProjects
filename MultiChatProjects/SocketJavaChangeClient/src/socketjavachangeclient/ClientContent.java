...
public class ClientContent extends javax.swing.JFrame {
            ...
            try {
                while ((msg = brc.readLine()) != null) {
                    if (msg.startsWith("cmd:")) {
                        ...
                        display.setText(display.getText() + "Server to you: " + m + "\n");
                    } else {
                        System.out.println("" + msg);
                        display.setText(display.getText() + msg + "\n");
                    }
     ...
     * @param name
     */
    public ClientContent(String name) {
        this.name = name;
        initComponents();
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Can't connect with server");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Chuỗi nhận về từ server:");
